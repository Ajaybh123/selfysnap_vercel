          ...
          <TableBody>
            {sellerOrder.orders.map((item: Order) => (
              <TableRow key={item._id}>
                ...
                <TableCell>
                  ₹{item.commission !== undefined ? item.commission : Math.round((item.totalSellingPrice || 0) * 0.10)}
                </TableCell>
                <TableCell>
                  ₹{item.netEarnings !== undefined ? item.netEarnings : (item.totalSellingPrice || 0) - (item.commission !== undefined ? item.commission : Math.round((item.totalSellingPrice || 0) * 0.10))}
                </TableCell>
                {/* <TableCell>
